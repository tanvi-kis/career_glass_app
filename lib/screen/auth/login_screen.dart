        ...
        ///password=
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        child: Text('Forgot password?',style: TextStyle(color: CColors.button,fontSize: 14,fontWeight: FontWeight.w700),))
                                  ],
                                ),
                                SizedBox(height: 8,),
          ...
          ///login button=
                                SizedBox(
                                  ...
                                  }, child: Text('Sign In',style: TextStyle(color: CColors.text,fontSize: 24),),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text('Or continue with',style: TextStyle(color: CColors.hinttext,fontSize: 14),),
                                    Expanded(
                                      child: Divider(
                                      color: CColors.hinttext,
                                        thickness: 1,
                                        ...
                                        child:Row(
                                          ...
                                          children: [
                                           Image.asset('assets/images/google.png',height: 20,width: 20),
                                            Text(' Google',style: TextStyle(color: CColors.text,fontSize: 14),),
                                          ],
                                        )
                                      ),
                                    ),
                                    ...
                                    Expanded(
                                      child: Container(
                                          ...
                                          child:Row(
                                            ...
                                            children: [
                                              Image.asset('assets/images/google.png',height: 20,width: 20,),
                                              Text(' Apple',style: TextStyle(color: CColors.text,fontSize: 14),),
                                            ],
                                          )
                                      ),
                                    ),
                                ...
                                Row(
                                  children: [
                                    Text("Don't have an account? ",style: TextStyle(color: CColors.text,fontSize: 14),),
                                    Text('Create Account',style: TextStyle(color: CColors.button,fontSize: 14),)
                                  ],
                                )
                              ],
                            ),
